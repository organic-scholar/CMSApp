  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="active">
          <a href="/tables/create"><i class="fa fa-link"></i> <span>Add Table</span></a>
        </li>

        @foreach (\App\Table::all() as $table)
          @if ($table->visible == 'on')
            <li>
              <a href="/content?type={{$table->name}}">
                <i class="fa fa-link"></i> <span>{{ $table->name }}</span>
              </a>
            </li>
          @endif
        @endforeach
...
<script type="text/javascript" src="/assets/js/table-create.js"></script>
